...
/// <include file='docs.xml' path='docs/members[@name="teeterTotterLever"]/TeeterTotterLeverPrefabBehaviour/*'/>
public class TeeterTotterLeverPrefabBehaviour : PiecePrefabBehaviour
{
    ...
    protected override void pieceSpecificSetup(){
        pieceDisplayName = "Teeter-totter Lever";
        snapToLayer = 18;
    ...
    public override void setTriggers(bool triggers){
        // recursively toggle the isTriggers property on all descendents with a Collider
